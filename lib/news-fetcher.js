...
Write a SHORT and CONCISE sports news article in English with:
...
- Only 4-5 sentences maximum
- Use *bold* for headlines only
...
`;
      ...
      const response = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "You are a sports journalist. Write VERY SHORT news articles in English. Maximum 4-5 sentences. Be concise and direct. Focus on the main facts only."
          },
          {
            role: "user",
            content: prompt
