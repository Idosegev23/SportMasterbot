...
Create a DETAILED English betting prediction with:

📊 ANALYSIS SECTION:
1. Team form analysis (2-3 lines)
2. Head-to-head insights 
3. Key player situations
4. Statistical trends

🎯 BETTING RECOMMENDATIONS:
1. PRIMARY bet with detailed reasoning
2. ALTERNATIVE betting options  
3. Risk assessment and confidence level
4. Expected outcome with score prediction

💡 KEY INSIGHTS:
- Critical factors affecting the match
- Value betting opportunities
- Risk management advice

Format for Telegram users with emojis and clear structure.
Use *bold* for key predictions and _italics_ for insights.

OUTPUT FORMAT (Telegram Markdown):
- Use *bold* for main predictions
- Use _italics_ for analysis insights  
- Use emojis appropriately
- No links (buttons added separately)
`;
      ...
      const response = await this.openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system", 
            content: "You are a professional sports betting analyst. Write ONLY in English. Create detailed, analytical predictions with clear structure. Include multiple betting options and thorough reasoning. Use Telegram Markdown formatting."
          },
          {
            role: "user",
            content: prompt
        ...
        max_tokens: 800, // Increased for detailed content
        temperature: 0.7
      });
